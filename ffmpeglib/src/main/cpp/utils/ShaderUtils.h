...
public:
     ...
     * @return
     */
    static GLuint CreateProgram(const GLchar *pVertexShaderSource, const GLchar *pFragShaderSource) {
        GLuint program = 0;
...
private:
     ...
     * @return
     */
    static GLuint LoadShader(GLenum shaderType, const GLchar *pSource) {
        LOGI("ShaderUtils::Load shader:\n %s", pSource)
        GLuint shader = 0;
