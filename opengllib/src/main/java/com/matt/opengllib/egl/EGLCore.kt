package com.matt.opengllib.egl
...
class EGLCore {
    ...
    fun init(eglContext: EGLContext?, flags: Int) {
        ...
        if (mEGLContext === EGL14.EGL_NO_CONTEXT) {
            val config = getConfig(flags, 3) ?: throw RuntimeException("Unable to find a suitable EGLConfig")
            val attr2List = intArrayOf(EGL14.EGL_CONTEXT_CLIENT_VERSION, 3, EGL14.EGL_NONE)
